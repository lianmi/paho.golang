...
func main() {
	...
	for m := range msgChan {
		...
		log.Println("jwtToken:", m.Properties.User.Get("jwtToken"))
		log.Println("deviceId:", m.Properties.User.Get("deviceId"))
		log.Println("businessType:", m.Properties.User.Get("businessType"))
		log.Println("businessSubType:", m.Properties.User.Get("businessSubType"))
		log.Println("taskId:", m.Properties.User.Get("taskId"))
